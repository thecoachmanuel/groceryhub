      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 w-full">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2 text-xs font-bold text-gray-500">
            ...
            <span>/</span>
            <span className="text-gray-900 dark:text-white">Popular Deals</span>
          </div>

          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <div className="inline-flex items-center gap-1.5 bg-orange-100 dark:bg-orange-950/40 text-orange-600 px-3 py-1 rounded-full text-xs font-black uppercase mb-1">
                <Flame size={14} /> Best Deals & Essentials
              </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all ${
                selectedCategory === cat.id
                  ...
                  : 'bg-white dark:bg-[#1e2632] text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800 hover:border-[#0aad0a]'
              }`}
            >
              {cat.label}
            </button>
